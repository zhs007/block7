...
type UserData struct {
	...
	LevelArr  map[int32]int32 `protobuf:"bytes,4,rep,name=LevelArr,proto3" json:"LevelArr,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	ToolsArr  map[int32]int32 `protobuf:"bytes,5,rep,name=ToolsArr,proto3" json:"ToolsArr,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
...
func (x *UserData) GetLevelArr() map[int32]int32 {
	if x != nil {
		return x.LevelArr
	}
	return nil
...
func (x *UserData) GetToolsArr() map[int32]int32 {
	if x != nil {
		return x.ToolsArr
	}
	return nil
...
var file_block7_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x53, 0x74, 0x61, 0x72, 0x4e, 0x75, 0x6d, 0x73, 0x22, 0xbf,
	0x03, 0x0a, 0x08, 0x55, 0x73, 0x65, 0x72, 0x44, 0x61, 0x74, 0x61, 0x12, 0x12, 0x0a, 0x04, 0x4e,
	...
	0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x1a, 0x3b, 0x0a, 0x0d, 0x4c, 0x65, 0x76, 0x65, 0x6c, 0x41,
	...
	0x68, 0x73, 0x30, 0x30, 0x37, 0x2f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x37, 0x2f, 0x62, 0x6c, 0x6f,
	0x63, 0x6b, 0x37, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
